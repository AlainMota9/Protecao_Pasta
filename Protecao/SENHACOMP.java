...
public class SENHACOMP extends javax.swing.JDialog {

    private char[] SENHA1 = new char[20];//ARMAZENA A PRIMEIRA SENHACOMP DIGITADA
    private char[] SENHA2 = new char[20];//ARMAZENA A SEGUNDA
    ...
    private void initComponents() {
        ...
        jLabel3.setText("PROCESSO DE CRIAÇÃO DE SENHA INICIADO!");
        ...
        jLabel5.setText("© 2014 Alain L. Mota. Todos os direitos reservados. ");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jPasswordField2, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE)
    ...
    public void CRIPTOGRAFAR() {
        SENHACRIPTO CRIPTO = new SENHACRIPTO();//Usando MD5
        CRIPTO.encrypt();
    ...
    private void jPasswordField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPasswordField2ActionPerformed
        SENHA2 = jPasswordField2.getPassword();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {                                      
        ...
        if (clickCount != 0) {
            ...
            if (!Arrays.equals(SENHA1, SENHA2)) {
                ...
                SENHACOMP COMP = new SENHACOMP();
                COMP.CONVERCAO();
                dispose();//FECHA A INTERFACE ATUAL
    ...
    public void SENHA1() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SENHACOMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
